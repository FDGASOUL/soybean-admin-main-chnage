<template>
  <!-- <n-grid cols="s:1 m:2 l:6" responsive="screen" :x-gap="16" :y-gap="16">
...
// import { fetchMissData } from '@/service';
...
//   startLoading();
//   const { data } = await fetchMissData();
// 	// console.log(data)
//   // cardData[0].value = data.nullsum[3];
