...
> = {
  ...
  association: () => import('./association/index.vue'),
  'auth-demo_permission': () => import('./auth-demo/permission/index.vue'),
  'auth-demo_super': () => import('./auth-demo/super/index.vue'),
  behavior_draw: () => import('./behavior/draw/index.vue'),
  behavior_feature: () => import('./behavior/feature/index.vue'),
  ...
  consume_eat: () => import('./consume/eat/index.vue'),
  consume_learn: () => import('./consume/learn/index.vue'),
  dashboard_analysis: () => import('./dashboard/analysis/index.vue'),
  dashboard_workbench: () => import('./dashboard/workbench/index.vue'),
  distribution_one: () => import('./distribution/one/index.vue'),
  distribution_quality: () => import('./distribution/quality/index.vue'),
  distribution_two: () => import('./distribution/two/index.vue'),
