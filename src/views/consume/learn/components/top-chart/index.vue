...
function echarts(data) {
  ...
  }人<br>建议学校对消费次数较少的学术场所进行调查和评估，了解学生对其设施和服务的需求和满意度，根据调查结果进行改进和提升，以提高学生对学术场所的使用率和满意度。同时，也可以考虑举办更多有吸引力的活动和提供更加便利的服务，吸引更多学生使用学术场所。`; // 更新消息，显示消费次数最多和最少的学术场所
}
...
function echarts1(data) {
  ...
  message += '<br>对比非工作日，工作日的整体消费次数明显更高，学生们更愿意在工作日在学术场所消费，符合常识。<br>建议学校根据工作日学术场所消费时间的特点，合理安排学术场所的开放时间，加强工作日学术场所的管理和服务，提高学生在工作日的学术场所消费体验，以满足学生的学习和生活需求。'; // 添加额外消息
...
function echarts2(data) {
  ...
  message +=
    '<br>对比工作日，非工作日的整体消费次数明显下降，原因可能是非工作日学生在宿舍休息或外出游玩，极少访问学术场所。<br>建议学校针对非工作日学术场所的消费情况，推出吸引学生的活动和服务，提高学生在非工作日的学术场所利用率，例如举办学术讲座、组织学术交流活动等，吸引学生积极参与。同时，也可以考虑在非工作日增加学术场所的开放时间，提供更加灵活的学习和休闲空间，满足学生的不同需求。'; // 添加额外消息
